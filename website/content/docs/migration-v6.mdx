...
npm 通路体积缩小约 40%，供应链面从 59 个包收窄到 3 个。如果连 Node.js 环境都不想引入，还可以彻底抛开 npm——原生 CLI 是纯 Rust 单二进制，功能与 npm 版完全一致，[`cargo install bumpp-cli`](/docs/install/crates-io) 之后没有任何 node_modules 和依赖包，相比 v5 缩小近一半。
