 ...
 * 按文件名分发进 `napi/<triple>/` 平台包目录，并把 `index.d.ts` 归位 core。
 *
 ...
 *   merge-multiple 的落点（7 个 .node + index.d.ts 同目录平铺）
 */
...
// index.d.ts 由 napi CLI 腿同车捎带（zigbuild 腿不产出，ADR-0025），先归位 core
