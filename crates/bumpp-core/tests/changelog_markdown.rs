...
use bumpp_core::commits::{parse_display_commit, ReferenceType};
use bumpp_core::git::{GitAuthor, RawCommit};
...
fn gitmoji_convert_replaces_codes_with_trailing_space() {
  use bumpp_core::changelog::gitmoji::convert_gitmoji;
...
use bumpp_core::changelog::config::{ChangelogConfig, ChangelogTypeEntry};
use bumpp_core::changelog::markdown::{generate_markdown, ReleaseRange};
use bumpp_core::changelog::render_changelog;
use bumpp_core::commits::{CommitReference, DisplayCommit};
use bumpp_core::git::RepoConfig;
